...
def create_output_images(Rover):
    ...
    # If there are, we'll step through the known sample positions to confirm whether detections are real
    samples_located = 0
    if rock_world_pos[0].any():
        ...
        for idx in range(len(Rover.samples_pos[0])):
            ...
            # If rocks within 3 meters of known sample plot the location of the known sample on the map
    ...
    # Calculate the number of good map pixel detections divided by total pixels found to be navigable terrain
    if tot_nav_pix > 0:
